...
let: block scoped. preferred for variable declaration. 
gives an error if called before declared. cannot be redeclared if in same scope. 
*/
// let greeting = "say Hi";
// let times = 4;
