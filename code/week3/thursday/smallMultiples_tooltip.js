...
*/
    ...
    enteringDay       
        .on("mouseover", function(d) {
            ...
            var xPosition = d3.select(this).node().transform.baseVal[0].matrix.e + dimensions.radius/2;
            var yPosition = d3.select(this).node().transform.baseVal[0].matrix.f + dimensions.radius/2;;
